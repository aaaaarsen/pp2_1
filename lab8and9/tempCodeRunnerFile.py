...
pencil = pygame.image.load('lab8/img/pencil.png')
...
eraser = pygame.image.load('lab8/img/eraser.png')
eraser = pygame.transform.scale(eraser, (75, 75))

figures = pygame.image.load('lab8/img/figures.png')
figures = pygame.transform.scale(figures, (75, 75))

rectangle = pygame.image.load('lab8/img/rectangle.png')
rectangle = pygame.transform.scale(rectangle, (75, 95))

circle = pygame.image.load('lab8/img/circle.png')
circle = pygame.transform.scale(circle, (75, 75))

pallete = pygame.image.load('lab8/img/palette.png')
